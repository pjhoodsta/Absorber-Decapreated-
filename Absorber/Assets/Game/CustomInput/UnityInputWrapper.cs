...
namespace Game.CustomInput {
    public class UnityInputWrapper : MonoInstaller, PlayerUnityInputAsset.IPlayer0GameplayActions{
        ...
        //override public void DependenciesResolved() {}

        public UnityInputWrapper() {
